...
?>
<title>web Page for Super Admin</title>
		...
		<div class="panel-heading">
			<div class="row">
				...
				<div class="col-md-2" align="right">
					<button type="button" name="add" id="addUser" class="btn btn-success btn-xs">Add User/Administrator</button>
				</div>
			</div>
		</div>
    			...
    			<div class="modal-content">
    				...
    				<div class="modal-body">
						...
						<div class="form-group">
							...
							<label class="radio-inline">
								<input type="radio" name="user_type" id="Customer" value="Customer" required>General
							</label>;
							<label class="radio-inline">
